...
Where "Plugin Name" is the name of the plugin in question - in this case the README will be read from the WordPress repository. Alternatively, you can specify a URL for where the README file is held. Local URLS are not supported. For example...

`[readme]http://www.artiss.co.uk/readme.txt[/readme]`
