...
function readme_parser( $paras = '', $content = '' ) {
    ...
    if ( !$result ) {
        ...
        if ( strtolower( $assets ) == 'yes' ) { $assets = true; } else { $assets = false; }
        ...
        if ( $file_data !== false ) {
            ...
            for ( $i = 0; $i < $count; $i++ ) {
                ...
                if ( $add_to_output ) {
                    ...
                    if ( ( substr( $file_array[ $i ], 0, 13 ) == 'Contributors:' ) or ( substr( $file_array[ $i ], 0, 12 ) == 'Donate link:' ) or ( substr( $file_array[ $i ], 0, 5 ) == 'Tags:' ) or ( substr( $file_array[ $i ], 0, 18 ) == 'Requires at least:' ) or ( substr( $file_array[ $i ], 0, 13 ) == 'Tested up to:' ) or ( substr( $file_array[ $i ], 0, 11 ) == 'Stable tag:' ) or ( substr( $file_array[ $i ], 0, 12 ) == 'License URI:' ) or ( substr( $file_array[ $i ], 0, 8 ) == 'License:' ) ) {
                        ...
                        if ( substr( $file_array[ $i ], 0, 12 ) == 'License URI:' ) {
            ...
            if ( ( $show_links ) && ( $links == 'bottom' ) ) { $file_combined .= arp_display_links( $download, $target, $nofollow, $version, $mirror, $plugin_name ); }
